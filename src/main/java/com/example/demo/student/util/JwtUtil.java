...
public class JwtUtil {
    ...
    private String SECRET_KEY = "secret-key-for-generation-of-jwt"; // This should be stored in a secure location

    private int jwtExpirationInMs = 1000 * 60 * 60 * 10;     // 10 hours
